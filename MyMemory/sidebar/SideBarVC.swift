...
class SideBarVC : UITableViewController{
    ...
    override func viewDidLoad() {
        ...
        self.nameLabel.frame = CGRect(x: 70, y: 30, width: 100, height: 30)
        
//        self.nameLabel.text = "꼼꼼한 재은 씨" //기본 텍스트
        ...
        self.emailLabel.frame = CGRect(x: 70, y: 15, width: 100, height: 30)
        
//        self.emailLabel.text = "sqlpro@naver.com" //기본 텍스트
        self.emailLabel.textColor = .white //텍스트 색상
        self.emailLabel.font = UIFont.boldSystemFont(ofSize: 11) //폰트 사이즈
...
//        self.profileImage.image = defaultProfile //이미지 등록
        self.profileImage.frame = CGRect(x: 10, y: 10, width: 50, height: 50) //위치 크기를 정함
